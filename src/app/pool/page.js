...
import { rpoolPage, rpoolDetailsPool } from "@/component/map/state"
    ...
    useEffect(() => {
        if (pool.nodes.length > 0) {
            ...
            setPageDetails({
                ...
                "maxRequestedAmount": (pool.nodes[0].maxRequestedAmount / pool.generalInfo[0].tokenDecimal) + ' ' + pool.generalInfo[0].tokenSymbol,
