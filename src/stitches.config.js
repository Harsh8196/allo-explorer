...
import { newColors as figmaColors } from './component/ui/new-colors';
...
export const colors = {
  ...
  mapNodeAccepted: figmaColors.success5,
  mapNodePending: figmaColors.error6,
  ...
  mapGiveLinkPending: figmaColors.error6,
  mapReceiveLink: figmaColors.orange6,
  mapReceiveLinkPending: figmaColors.orange2,
...
export const Theme = 'dark' | undefined;
